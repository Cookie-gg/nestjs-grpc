...
proto.user.UpdateUserRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, 0),
    updates: (f = msg.getUpdates()) && proto.user.CreateUserRequest.toObject(includeInstance, f)
  };
...
proto.user.UpdateUserRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.user.CreateUserRequest;
      reader.readMessage(value,proto.user.CreateUserRequest.deserializeBinaryFromReader);
...
proto.user.UpdateUserRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.user.CreateUserRequest.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional CreateUserRequest updates = 2;
 * @return {?proto.user.CreateUserRequest}
 */
proto.user.UpdateUserRequest.prototype.getUpdates = function() {
  return /** @type{?proto.user.CreateUserRequest} */ (
    jspb.Message.getWrapperField(this, proto.user.CreateUserRequest, 2));
};


/**
 * @param {?proto.user.CreateUserRequest|undefined} value
 * @return {!proto.user.UpdateUserRequest} returns this
*/
proto.user.UpdateUserRequest.prototype.setUpdates = function(value) {
 ...
 * @return {!proto.user.UpdateUserRequest} returns this
 */
proto.user.UpdateUserRequest.prototype.clearUpdates = function() {
 ...
 * @return {boolean}
 */
proto.user.UpdateUserRequest.prototype.hasUpdates = function() {
